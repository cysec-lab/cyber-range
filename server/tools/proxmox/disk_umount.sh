...
#vgrename $OLD_VG_NAME $VG_NAME      # kernel panicの原因
#vgchange --uuid $VG_NAME
##vgchange -ay $OLD_VG_NAME
#vgchange -ay $VG_NAME
...
#sed -i -e "s/$OLD_VG_NAME/$VM_NUM/g" /mnt/vm$VM_NUM/grub/grub.conf
#umount /mnt/vm$VM_NUM
#
## Phisical Volume mount
##mount /dev/$OLD_VG_NAME/lv_root /mnt/vm$VM_NUM
...
#sed -i -e "s/$OLD_VG_NAME/$VM_NUM/g" /mnt/vm$VM_NUM/etc/fstab
#
## VM clone setup
